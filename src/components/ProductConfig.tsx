    ...
    <>
      {
        currentCartLenght === 0 || !currentCartLenght ?
          ...
          <button
            onClick={addTocart}
            className="bg-purple-600 lg:hover:scale-125 duration-300 rounded font-semibold text-white text-2xl shadow p-4" >
            Add to Cart
          </button>
          :
          <div
            className="bg-purple-600 flex justify-around lg:w-[40%] m-auto items-center rounded font-semibold text-white text-2xl shadow p-4" >
