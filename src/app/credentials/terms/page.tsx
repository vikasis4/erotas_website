...
function page() {
  return (
    <div className="felx font-poppin px-12 py-16 md:px-24 flex-col justify-center  mt-8 items-center">
      <h1 className="text-6xl text-center font-bold">Terms & Conditions</h1>
      <h1 className="text-2xl mt-12 font-medium">
        These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
        agreement by and between ARCHANA, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or
        ...
        updates.<br/><br/><br/>
        The use of this website or availing of our Services is subject to the following terms of use:<br/><br/><br/>
        ...
        * Neither we nor any third parties provide any warranty or guarantee as to the accuracy, timeliness,
        ...
        inaccuracies or errors to the fullest extent permitted by law.<br/><br/><br/>
        * Your use of our Services and the websiteis solely at your own risk and discretion.. You are
        required to independently assess and ensure that the Services meet your requirements.<br/><br/><br/>
        * The contents of the Website and the Services are proprietary to Us and you will not have any
        * authority to claim any intellectual property rights, title, or interest in its contents.<br/><br/><br/>
        * You acknowledge that unauthorized use of the Website or the Services may lead to action against
        you as per these Terms or applicable laws.<br/><br/><br/>
        * You agree to pay us the charges associated with availing the Services.<br/><br/><br/>
        * You agree not to use the website and/ or Services for any purpose that is unlawful, illegal or
        forbidden by these Terms, or Indian or local laws that might apply to you.<br/><br/><br/>
        * You agree and acknowledge that website and the Services may contain links to other third party
        ...
        such other policies of such third party websites.<br/><br/><br/>
        * You understand that upon initiating a transaction for availing the Services you are entering into a
        legally binding and enforceable contract with the us for the Services.<br/><br/><br/>
