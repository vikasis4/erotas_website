...
function SimpleAddress({ data }: { data: AddressType }) {
    ...
    var style = _id === 'yo' ?
        "flex bg-red-100 relative flex-wrap m-auto w-[95%] font-poppin gap-2 rounded-md p-1"
        :
        "flex bg-red-100 relative flex-wrap m-auto w-[90%] font-poppin gap-4 shadow-md rounded-md p-4"
