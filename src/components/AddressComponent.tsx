                ...
                showConfig ?
                    ...
                    <div className="flex bg-red-100 relative flex-wrap w-full lg:w-1/2 font-poppin gap-4 shadow-md rounded-md p-4">
                        <div className="absolute top-1 right-1 flex gap-2 p-2">
                            <Image onClick={() => setShowConfig(true)} className="lg:hover:cursor-pointer" src={require('../assets/icon/edit.png')} alt="erota" height="25" width="25" />
                            <Image onClick={() => deleteAddress(_id)} className="lg:hover:cursor-pointer" src={require('../assets/icon/delete.png')} alt="erota" height="25" width="25" />
                        </div>
