...
function ProductMap({ data }: any) {
    ...
    return (
        ...
        className=" hover:cursor-pointer flex flex-col justify-center items-center w-[45%] shadow-md md:w-[40%] py-4 overflow-hidden rounded-xl bg-white md:hover:scale-125 duration-300 ">
